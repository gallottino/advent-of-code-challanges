...
def antinodes(node_1: Position, node_2: Position, _: list[list[str]]) -> tuple[Position, Position]:
...
def multiple_antinodes(node_1: Position, node_2: Position, city: list[list[str]]) -> tuple[Position, Position]:
